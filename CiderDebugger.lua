...
local CiderRunMode = {};CiderRunMode.runmode = 'DEBUG';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/CetoBasilius/Library/Application Support/luaglider2/dev";local SOCKET_PORT=60023;local GLIDER_MAIN_FOLDER= "/Users/CetoBasilius/Documents/Projects/MinigamesDemo";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
